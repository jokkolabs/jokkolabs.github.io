...
(function() {
  ...
  LightboxOptions = (function() {
    ...
    function LightboxOptions() {
      this.fileLoadingImage = '/stylesheets/img/loading.gif';
      this.fileCloseImage = '/stylesheets/img/close.png';
  ...
  Lightbox = (function() {
    ...
    Lightbox.prototype.build = function() {
      ...
      $lightbox.hide().on('click', function(e) {
        if ($(e.target).prop('id') === 'lightbox') _this.end();
        return false;
      });
    ...
    Lightbox.prototype.changeImage = function(imageNumber) {
      ...
      preloader.onload = function() {
        $image.prop('src', _this.album[imageNumber].link);
